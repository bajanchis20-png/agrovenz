<script lang="ts">
    ...
    const productos: { id: number, title: string, cat: string, price: number | string, images: string[], desc: string, link?: string }[] = [
        ...
        { id: 65, title: "Minerfun F.M. (100 ml)", cat: "Veterinaria", price: 11.01, images: ["/mineral.jpeg"], desc: "Suplemento mineral y vitamínico." },
        { id: 66, title: "Minerfun F.M. (500 ml)", cat: "Veterinaria", price: 34.59, images: ["/mineral.jpeg"], desc: "Presentación de 500 ml Minerfun F.M." },
        { id: 67, title: "Minerfun MX (250 ml)", cat: "Veterinaria", price: 40.58, images: ["/mineral.jpeg"], desc: "Suplemento mineral avanzado." },
